...
// ==============================================================
#ifndef __convolve_kernel_mfYi__HH__
#define __convolve_kernel_mfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolve_kernel_mfYi) {
    ...
    SC_CTOR(convolve_kernel_mfYi):  simcore_mac_2_U ("simcore_mac_2_U") {
