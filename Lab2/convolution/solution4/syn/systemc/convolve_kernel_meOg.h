...
// ==============================================================
#ifndef __convolve_kernel_meOg__HH__
#define __convolve_kernel_meOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolve_kernel_meOg) {
    ...
    SC_CTOR(convolve_kernel_meOg):  simcore_mac_1_U ("simcore_mac_1_U") {
