...
// ==============================================================
#ifndef __convolve_kernel_mhbi__HH__
#define __convolve_kernel_mhbi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolve_kernel_mhbi) {
    ...
    SC_CTOR(convolve_kernel_mhbi):  simcore_mac_4_U ("simcore_mac_4_U") {
