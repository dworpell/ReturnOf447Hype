...
// ==============================================================
#ifndef __convolve_kernel_mdEe__HH__
#define __convolve_kernel_mdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolve_kernel_mdEe) {
    ...
    SC_CTOR(convolve_kernel_mdEe):  simcore_mac_0_U ("simcore_mac_0_U") {
