...
// ==============================================================
#ifndef __convolve_kernel_fcud__HH__
#define __convolve_kernel_fcud__HH__
#include "ACMP_fmul.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolve_kernel_fcud) {
    ...
    SC_CTOR(convolve_kernel_fcud):  ACMP_fmul_U ("ACMP_fmul_U") {
        ACMP_fmul_U.clk(clk);
