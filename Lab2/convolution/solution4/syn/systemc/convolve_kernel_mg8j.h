...
// ==============================================================
#ifndef __convolve_kernel_mg8j__HH__
#define __convolve_kernel_mg8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolve_kernel_mg8j) {
    ...
    SC_CTOR(convolve_kernel_mg8j):  simcore_mac_3_U ("simcore_mac_3_U") {
